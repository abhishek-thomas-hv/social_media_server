...
export const addCommentForPost = async (req,res) =>
{
    ...
    try{
        ...
        const updatedPost = await Post.findByIdAndUpdate(postId,{ $push: { 
...
export const addLikeForPost = async (req,res) =>
{
    ...
    try{
        ...
        const updatedPost = await Post.findByIdAndUpdate(_id,{likeCount:post.likeCount+1, $push: { 
            likedUsers: uid
          }
        },{new:true}).lean()
...
export const removeLikeForPost = async (req,res) =>
{
    ...
    try{
        const post = await Post.findById(_id)
        const updatedPost = await Post.findByIdAndUpdate(_id,{likeCount:post.likeCount-1, $pull: { 
            likedUsers: uid
          }
        },{new:true}).lean()
